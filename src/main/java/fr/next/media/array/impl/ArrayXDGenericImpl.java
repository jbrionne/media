...
public class ArrayXDGenericImpl<T, K, G extends Axe<? extends AxeVal<K>>> extends AbstractArrayXDOrdDomains<T, K, G> implements ArrayXDOrd<T, K, G> {
	...
	public ArrayXDGenericImpl(Class<T> clazz, G... domains) {
		this.clazz = clazz;
	...
	public ArrayXDOrd<T, K, Axe<? extends AxeVal<K>>> addAxe(G axe) {
		...
		ArrayXDOrd<T, K, Axe<? extends AxeVal<K>>> a = new ArrayXDGenericImpl<>(clazz, newDomains);
