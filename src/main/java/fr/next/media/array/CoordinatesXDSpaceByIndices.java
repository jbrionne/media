...
public class CoordinatesXDSpaceByIndices<T, K, G extends Axe<? extends AxeVal<K>>> implements CoordinatesXD<T, K, G>, Serializable {
	
	
	private ArrayXDOrd<T, K, G> axes;

	private ArrayXDOrd<Float, K, G> transformIndices;
	//ArrayXDOrd<Float, K, G>

	public CoordinatesXDSpaceByIndices(ArrayXDOrd<T, K, G> axes, ArrayXDOrd<Float, K, G> transformIndices) {
		super();
		this.axes = axes;
	...
	public ArrayXDOrd<Float, K, G> getTransform() {
