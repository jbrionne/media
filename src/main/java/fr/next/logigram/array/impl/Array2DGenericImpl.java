...
public class Array2DGenericImpl<T, K, G extends Axe<? extends AxeVal<K>>> implements ArrayXDOrd<T, K, G>  {
	...
	public Array2DGenericImpl(Class<T> clazz, G domainLine2, G domainCol2, CoordinatesXDByIndices coordinates) {
		this.clazz = clazz;
